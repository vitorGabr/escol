  ...
  Widget _body() => Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
        image: AssetImage(
          'assets/main_login_page_bg.jpg'
        ),
        colorFilter: ColorFilter.mode(secondaryColor.withOpacity(0.5), BlendMode.srcOver),
        fit: BoxFit.cover
      )
    ),
    child: Column(
                ...
                child: RaisedButton(
                  ...
                  onPressed: (){
                    Navigator
                      .of(context)
                      .pushReplacement(
                      new MaterialPageRoute(builder: (BuildContext context) => StudentPage())
                    );
                  },
                  child: Row(
                ...
                child: RaisedButton(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(width: _ac.rW(3)),
                      Icon(Icons.arrow_forward,size: 20,color: primary,)
                    ],
                  )
                )
              )
