...
class PostCard extends StatelessWidget {
  ...
  const PostCard({Key key, @required this.news}) : super(key: key);
          ...
          children: [
            ...
            Padding(
                ...
                child: CachedNetworkImage(
                    ...
                    errorWidget: (context, url, error) => Icon(Icons.error),
                    imageUrl: '${news.image}')),
            news.description != '' ? SizedBox(height: _ac.rHP(2)) : Container(),
